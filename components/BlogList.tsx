...
function BlogList({posts}: Props) {
  ...
  return (
    <div>
        <hr className="border-[#93adc4] mb-10"/>

        <div className="grid grid-cols-1 md:grid-cols-2 px-8 gap-8 gap-y-16
        pb-24">
           {posts.map((post)=>(
                    ...
                    bg-black backdrop-blur-lg rounded drop-shadow-lg text-white p-5 flex justify-between">
                        ...
                        <div className="flex flex-col md:flex-row gap-y-2 md:gap-x-2 items-center">
                            {post.categories.map((category) => (
                               <div className="bg-[#426b9a] text-center text-black px-3 py-1
